...
const register = async (userData) => {
    ...
    if (gdprConsent !== true && gdprConsent !== 'true') {
        throw new Error("Explicit GDPR consent is required to create an account.");
    }
    ...
    // Creates new user (El createdAt se genera automáticamente y sirve como timestamp del GDPR)
